...
class HealthApi:
    ...
    def health_check_detailed(
        ...
        _param = self._health_check_detailed_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "HealthCheckDetailed200Response",
            '401': "Error",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def health_check_detailed_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HealthCheckDetailed200Response]:
        """Detailed health check
    ...
    @validate_call
    def health_check_detailed_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _health_check_detailed_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
