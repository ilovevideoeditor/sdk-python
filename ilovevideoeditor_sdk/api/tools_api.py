...
class ToolsApi:
    ...
    def download_tool_job(
        ...
        _param = self._download_tool_job_serialize(
            id=id,
    ...
    @validate_call
    def download_tool_job_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def download_tool_job_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _download_tool_job_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tools/jobs/{id}/download',
    ...
    def get_tool_job(
        ...
        _param = self._get_tool_job_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tool_job_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tool_job_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _get_tool_job_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tools/jobs/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def queue_tool_job(
        ...
        :type tool_id: str
        :param tool_job_request: (required)
        :type tool_job_request: ToolJobRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._queue_tool_job_serialize(
            tool_id=tool_id,
    ...
    @validate_call
    def queue_tool_job_with_http_info(
        self,
        tool_id: StrictStr,
        tool_job_request: ToolJobRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def queue_tool_job_without_preload_content(
        self,
        tool_id: StrictStr,
        tool_job_request: ToolJobRequest,
        _request_timeout: Union[
    ...
    def _queue_tool_job_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if tool_job_request is not None:
            _body_params = tool_job_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tools/{toolId}/jobs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
