...
from ilovevideoeditor_sdk.configuration import Configuration
from ilovevideoeditor_sdk.api_response import ApiResponse, T as ApiResponseT
import ilovevideoeditor_sdk.models
from ilovevideoeditor_sdk import rest
from ilovevideoeditor_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ilovevideoeditor_sdk.models, klass)
