...
class DestinationInput(BaseModel):
    ...
    path_prefix: Optional[StrictStr] = Field(default='', alias="pathPrefix")
    __properties: ClassVar[List[str]] = ["provider", "endpoint", "region", "bucket", "accessKeyId", "secretAccessKey", "publicUrl", "pathPrefix"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pathPrefix": obj.get("pathPrefix") if obj.get("pathPrefix") is not None else ''
        })
        return _obj
