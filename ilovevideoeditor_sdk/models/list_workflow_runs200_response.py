...
class ListWorkflowRuns200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["runs", "total", "page", "limit", "totalPages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListWorkflowRuns200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListWorkflowRuns200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "runs": [WorkflowRun.from_dict(_item) for _item in obj["runs"]] if obj.get("runs") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
