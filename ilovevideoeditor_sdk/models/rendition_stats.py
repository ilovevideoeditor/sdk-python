...
class RenditionStats(BaseModel):
    """
    RenditionStats
    """ # noqa: E501
    ...
    processing: Optional[StrictInt] = None
    queued: Optional[StrictInt] = None
    rendering: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total", "completed", "failed", "processing", "queued", "rendering"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RenditionStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RenditionStats from a dict"""
        if obj is None:
            return None
