...
class EstimateRenderCostRequest(BaseModel):
    """
    EstimateRenderCostRequest
    """ # noqa: E501
    video_json: VideoJSON = Field(alias="videoJSON")
    __properties: ClassVar[List[str]] = ["videoJSON"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EstimateRenderCostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of video_json
        if self.video_json:
            _dict['videoJSON'] = self.video_json.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EstimateRenderCostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "videoJSON": VideoJSON.from_dict(obj["videoJSON"]) if obj.get("videoJSON") is not None else None
        })
        return _obj
