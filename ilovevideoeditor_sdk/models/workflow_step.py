...
class WorkflowStep(BaseModel):
    ...
    max_retries: Optional[Annotated[int, Field(le=10, strict=True, ge=0)]] = Field(default=None, alias="maxRetries")
    config: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["type", "name", "maxRetries", "config"]
