...
class CreditBalanceUsage(BaseModel):
    """
    CreditBalanceUsage
    """ # noqa: E501
    storage: Optional[Dict[str, Any]] = None
    bandwidth: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["storage", "bandwidth"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreditBalanceUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreditBalanceUsage from a dict"""
        if obj is None:
            return None
