...
class GetWorkflowRun200Response(BaseModel):
    """
    GetWorkflowRun200Response
    """ # noqa: E501
    run: WorkflowRun
    steps: Optional[List[WorkflowRunStep]] = None
    __properties: ClassVar[List[str]] = ["run", "steps"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWorkflowRun200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWorkflowRun200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "run": WorkflowRun.from_dict(obj["run"]) if obj.get("run") is not None else None,
            "steps": [WorkflowRunStep.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
