...
class AssetCreate(BaseModel):
    ...
    name: StrictStr
    type: StrictStr
    storage_key: StrictStr = Field(description="Bunny Storage path (must start with workspace_id/).")
    size_bytes: Optional[StrictInt] = None
    duration: Optional[StrictInt] = None
    width: Optional[StrictInt] = None
    height: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "storage_key", "size_bytes", "duration", "width", "height"]
