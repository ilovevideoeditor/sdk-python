...
class ListWorkflowPresets200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListWorkflowPresets200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListWorkflowPresets200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "presets": [WorkflowPreset.from_dict(_item) for _item in obj["presets"]] if obj.get("presets") is not None else None
        })
        return _obj
