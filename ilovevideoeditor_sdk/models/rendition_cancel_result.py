...
class RenditionCancelResult(BaseModel):
    """
    ...
    status: StrictStr
    refunded: Union[StrictFloat, StrictInt]
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "jobId", "status", "refunded", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RenditionCancelResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RenditionCancelResult from a dict"""
        if obj is None:
            return None
