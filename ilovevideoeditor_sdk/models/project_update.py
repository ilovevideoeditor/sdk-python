...
class ProjectUpdate(BaseModel):
    ...
    thumbnail_base64: Optional[StrictStr] = Field(default=None, description="Base64-encoded thumbnail image. Uploaded to Bunny Storage.")
    sprite_url: Optional[StrictStr] = None
    sprite_base64: Optional[StrictStr] = Field(default=None, description="Base64-encoded sprite sheet. Uploaded to Bunny Storage.")
    last_opened_at: Optional[datetime] = None
    duration: Optional[StrictInt] = None
    width: Optional[StrictInt] = None
    height: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "description", "video_json", "thumbnail_url", "thumbnail_base64", "sprite_url", "sprite_base64", "last_opened_at", "duration", "width", "height"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thumbnail_base64": obj.get("thumbnail_base64"),
            "sprite_url": obj.get("sprite_url"),
            "sprite_base64": obj.get("sprite_base64"),
