...
class AssetUploadUrlResponse(BaseModel):
    ...
    """ # noqa: E501
    upload_url: StrictStr = Field(description="Relative URL to POST the file to (`/v1/assets/{assetId}/upload`).", alias="uploadUrl")
    asset_url: StrictStr = Field(description="Public Bunny CDN URL once uploaded.", alias="assetUrl")
    path: StrictStr = Field(description="Bunny Storage path.")
    asset_id: UUID = Field(alias="assetId")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["uploadUrl", "assetUrl", "path", "assetId", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetUploadUrlResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetUploadUrlResponse from a dict"""
        if obj is None:
            return None
