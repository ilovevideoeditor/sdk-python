...
class WebhookSubscriptionCreate(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="Endpoint that receives signed render events.")
    events: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="Events to subscribe to; defaults to all events.")
    ...
    def events_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['render.completed', 'render.failed']):
                raise ValueError("each list item must be one of ('render.completed', 'render.failed')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionCreate from a dict"""
        if obj is None:
            return None
