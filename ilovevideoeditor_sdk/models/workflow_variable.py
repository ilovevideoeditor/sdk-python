...
class WorkflowVariable(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "label", "required", "default", "placeholder"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['string', 'number', 'boolean', 'asset_url', 'url', 'text']):
            raise ValueError("must be one of enum values ('string', 'number', 'boolean', 'asset_url', 'url', 'text')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowVariable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowVariable from a dict"""
        if obj is None:
            return None
