...
class GetWorkflow200Response(BaseModel):
    """
    GetWorkflow200Response
    """ # noqa: E501
    workflow: Workflow
    recent_runs: Optional[List[WorkflowRun]] = Field(default=None, alias="recentRuns")
    __properties: ClassVar[List[str]] = ["workflow", "recentRuns"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWorkflow200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWorkflow200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "recentRuns": [WorkflowRun.from_dict(_item) for _item in obj["recentRuns"]] if obj.get("recentRuns") is not None else None
        })
        return _obj
