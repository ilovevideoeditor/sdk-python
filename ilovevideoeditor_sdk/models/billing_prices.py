...
class BillingPrices(BaseModel):
    ...
    BillingPrices
    """ # noqa: E501
    tiers: Optional[BillingPricesTiers] = None
    credits: Optional[Dict[str, Optional[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["tiers", "credits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BillingPrices from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BillingPrices from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tiers": BillingPricesTiers.from_dict(obj["tiers"]) if obj.get("tiers") is not None else None,
