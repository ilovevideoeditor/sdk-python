...
class WorkspaceIntegration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "workspaceId", "provider", "name", "isActive", "isDefault", "config", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceIntegration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceIntegration from a dict"""
        if obj is None:
            return None
