...
class WorkspaceIntegrationInput(BaseModel):
    ...
    config: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["provider", "name", "isActive", "isDefault", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceIntegrationInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceIntegrationInput from a dict"""
        if obj is None:
            return None
