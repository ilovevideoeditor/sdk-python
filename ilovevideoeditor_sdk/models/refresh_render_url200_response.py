...
class RefreshRenderUrl200Response(BaseModel):
    """
    RefreshRenderUrl200Response
    """ # noqa: E501
    download_url: StrictStr = Field(alias="downloadUrl")
    expires_in_seconds: StrictInt = Field(alias="expiresInSeconds")
    __properties: ClassVar[List[str]] = ["downloadUrl", "expiresInSeconds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RefreshRenderUrl200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RefreshRenderUrl200Response from a dict"""
        if obj is None:
            return None
