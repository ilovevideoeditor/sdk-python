...
class GetProject200Response(BaseModel):
    """
    GetProject200Response
    """ # noqa: E501
    project: Project
    last_rendition: Optional[Rendition] = Field(default=None, alias="lastRendition")
    __properties: ClassVar[List[str]] = ["project", "lastRendition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetProject200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_rendition
        if self.last_rendition:
            _dict['lastRendition'] = self.last_rendition.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetProject200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lastRendition": Rendition.from_dict(obj["lastRendition"]) if obj.get("lastRendition") is not None else None
        })
        return _obj
