...
class ListWorkflowStepTypes200Response(BaseModel):
    """
    ListWorkflowStepTypes200Response
    """ # noqa: E501
    step_types: List[Dict[str, Any]] = Field(alias="stepTypes")
    __properties: ClassVar[List[str]] = ["stepTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListWorkflowStepTypes200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListWorkflowStepTypes200Response from a dict"""
        if obj is None:
            return None
