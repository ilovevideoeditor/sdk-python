...
class CreditBalanceSummary(BaseModel):
    ...
    """ # noqa: E501
    purchased: Optional[Union[StrictFloat, StrictInt]] = None
    consumed: Optional[Union[StrictFloat, StrictInt]] = None
    refunded: Optional[Union[StrictFloat, StrictInt]] = None
    consumed30_days: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="consumed30Days")
    __properties: ClassVar[List[str]] = ["purchased", "consumed", "refunded", "consumed30Days"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consumed30Days": obj.get("consumed30Days")
        })
        return _obj
