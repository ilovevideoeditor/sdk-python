...
class CreditBalance(BaseModel):
    ...
    summary: Optional[CreditBalanceSummary] = None
    usage: Optional[CreditBalanceUsage] = None
    logs: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["balance", "total", "summary", "usage", "logs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "summary": CreditBalanceSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "usage": CreditBalanceUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
            "logs": obj.get("logs")
        })
        return _obj
