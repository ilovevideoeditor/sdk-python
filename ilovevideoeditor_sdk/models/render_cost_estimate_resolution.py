...
class RenderCostEstimateResolution(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["width", "height", "label"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RenderCostEstimateResolution from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RenderCostEstimateResolution from a dict"""
        if obj is None:
            return None
