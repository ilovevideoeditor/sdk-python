...
class GetRendition200Response(BaseModel):
    """
    GetRendition200Response
    """ # noqa: E501
    rendition: Rendition
    __properties: ClassVar[List[str]] = ["rendition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRendition200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rendition
        if self.rendition:
            _dict['rendition'] = self.rendition.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRendition200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rendition": Rendition.from_dict(obj["rendition"]) if obj.get("rendition") is not None else None
        })
        return _obj
