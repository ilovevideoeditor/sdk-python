...
class HealthCheckDetailed200ResponseServices(BaseModel):
    """
    HealthCheckDetailed200ResponseServices
    """ # noqa: E501
    redis: Optional[ServiceHealth] = None
    supabase: Optional[ServiceHealth] = None
    __properties: ClassVar[List[str]] = ["redis", "supabase"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HealthCheckDetailed200ResponseServices from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of supabase
        if self.supabase:
            _dict['supabase'] = self.supabase.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HealthCheckDetailed200ResponseServices from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "redis": ServiceHealth.from_dict(obj["redis"]) if obj.get("redis") is not None else None,
            "supabase": ServiceHealth.from_dict(obj["supabase"]) if obj.get("supabase") is not None else None
        })
        return _obj
