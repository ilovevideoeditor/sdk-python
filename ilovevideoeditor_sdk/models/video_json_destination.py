...
class VideoJSONDestination(BaseModel):
    """
    ...
    """ # noqa: E501
    integration_id: StrictStr = Field(description="Workspace integration identifier.", alias="integrationId")
    provider: StrictStr = Field(description="Storage provider the integration is configured for.")
    path_prefix: Optional[StrictStr] = Field(default=None, description="Optional path prefix override for this render.", alias="pathPrefix")
    __properties: ClassVar[List[str]] = ["integrationId", "provider", "pathPrefix"]

    @field_validator('provider')
    def provider_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['s3', 'r2', 'b2', 'wasabi', 'gcs', 'azure', 'drive']):
            raise ValueError("must be one of enum values ('s3', 'r2', 'b2', 'wasabi', 'gcs', 'azure', 'drive')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VideoJSONDestination from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VideoJSONDestination from a dict"""
        if obj is None:
            return None
