...
class ApiKeyWithSecret(BaseModel):
    ...
    ApiKeyWithSecret
    """ # noqa: E501
    key: StrictStr = Field(description="Full API key secret. Shown only once on creation.")
    key_data: ApiKey = Field(alias="keyData")
    __properties: ClassVar[List[str]] = ["key", "keyData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "keyData": ApiKey.from_dict(obj["keyData"]) if obj.get("keyData") is not None else None
        })
        return _obj
