...
class TierInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tier", "credits"]

    @field_validator('tier')
    def tier_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['free', 'starter', 'pro', 'business', 'enterprise']):
            raise ValueError("must be one of enum values ('free', 'starter', 'pro', 'business', 'enterprise')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TierInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TierInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tier": obj.get("tier"),
            "credits": TierInfoCredits.from_dict(obj["credits"]) if obj.get("credits") is not None else None
        })
        return _obj
