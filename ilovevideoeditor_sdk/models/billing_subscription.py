...
class BillingSubscription(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr
    current_period_end: Optional[datetime] = Field(alias="currentPeriodEnd")
    credits_balance: Union[StrictFloat, StrictInt] = Field(alias="creditsBalance")
    credits_total: Union[StrictFloat, StrictInt] = Field(alias="creditsTotal")
    tier: StrictStr
    __properties: ClassVar[List[str]] = ["status", "currentPeriodEnd", "creditsBalance", "creditsTotal", "tier"]
