...
class TierInfoCredits(BaseModel):
    """
    TierInfoCredits
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["balance", "monthly", "max"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TierInfoCredits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TierInfoCredits from a dict"""
        if obj is None:
            return None
