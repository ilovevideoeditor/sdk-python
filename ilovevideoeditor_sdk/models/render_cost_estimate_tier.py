...
class RenderCostEstimateTier(BaseModel):
    """
    RenderCostEstimateTier
    """ # noqa: E501
    tier: Optional[StrictStr] = None
    credits_balance: Optional[Union[StrictFloat, StrictInt]] = None
    monthly_credits: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["tier", "credits_balance", "monthly_credits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RenderCostEstimateTier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RenderCostEstimateTier from a dict"""
        if obj is None:
            return None
