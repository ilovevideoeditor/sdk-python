...
class GetRenderDownloadUrl200Response(BaseModel):
    """
    GetRenderDownloadUrl200Response
    """ # noqa: E501
    download_url: StrictStr = Field(alias="downloadUrl")
    filename: StrictStr
    __properties: ClassVar[List[str]] = ["downloadUrl", "filename"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRenderDownloadUrl200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRenderDownloadUrl200Response from a dict"""
        if obj is None:
            return None
