...
class QueueRenderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["videoJSON", "webhookUrl", "projectId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueueRenderRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueueRenderRequest from a dict"""
        if obj is None:
            return None
